...
function normalizeSimulateResponse(value: unknown): SimulateAccessResponse {
  ...
  return {
    ...
    subject_display_name:
      typeof raw.subject_display_name === "string"
        ? raw.subject_display_name
        : null,
    subject_email:
      typeof raw.subject_email === "string" ? raw.subject_email : "",
    ...
    effective_permissions: Array.isArray(raw.effective_permissions)
      ? (raw.effective_permissions as unknown[]).filter(
