...
export function FeaturePlaceholder({ title, summary, hints }: FeaturePlaceholderProps) {
  return (
    <div className="px-4 py-6 lg:px-8 lg:py-8">
      <section className="mb-6 rounded-2xl border border-[#d8d5e8] bg-white p-6">
        <p className="mb-2 text-xs font-bold uppercase tracking-[0.15em] text-[#5d58a8]">Rudix Product Surface</p>
      ...
      <section className="rounded-2xl border border-[#d8d5e8] bg-white p-6">
        <h3 className="mb-3 text-sm font-bold uppercase tracking-wide text-[#5f5a74]">Foundational Behaviors</h3>
        ...
        <p className="mt-4 text-sm text-[#66627a]">
          ...
          <Link href="/rag-pipeline" className="font-semibold text-[#3525cd] underline decoration-[#bbb5e5]">
            Pipeline Explorer
          </Link>
          .
        </p>
