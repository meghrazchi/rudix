...
protected_router.include_router(agent_runs.admin_trace_router)
protected_router.include_router(ab_testing.router)
...
protected_router.include_router(admin_agent_policy.router)
