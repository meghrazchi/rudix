...
async def build_document_resource_context(
    ...
    *,
    ...
    return ResourceContext(
        ...
        owner_user_id=str(document.uploaded_by_user_id) if document.uploaded_by_user_id else None,
    ...
    for doc in documents:
        ...
        contexts.append(
            ResourceContext(
                ...
                resource_id=doc_id_str,
                organization_id=str(organization_id),
                owner_user_id=str(doc.uploaded_by_user_id) if doc.uploaded_by_user_id else None,
