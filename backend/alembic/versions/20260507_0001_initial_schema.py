...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            ...
            name=op.f("ck_organization_members_organization_members_role_allowed"),
        ),
        sa.ForeignKeyConstraint(
            ["organization_id"],
            ["organizations.id"],
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            ...
            name=op.f("ck_documents_documents_file_type_allowed"),
        ),
        sa.CheckConstraint(
            "page_count IS NULL OR page_count >= 0",
            name=op.f("ck_documents_documents_page_count_non_negative"),
        ),
        sa.CheckConstraint(
    ...
    op.create_index(
        "idx_documents_org_status", "documents", ["organization_id", "status"], unique=False
    )
    ...
    op.create_index(
        "idx_chat_sessions_user", "chat_sessions", ["user_id", "created_at"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "char_count >= 0", name=op.f("ck_document_pages_document_pages_char_count_non_negative")
        ),
        sa.CheckConstraint(
            "page_number >= 1", name=op.f("ck_document_pages_document_pages_page_number_positive")
        ),
        sa.ForeignKeyConstraint(
            ["document_id"],
            ["documents.id"],
    ...
    op.create_index(
        "idx_document_pages_document_id", "document_pages", ["document_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "chunk_index >= 0",
            name=op.f("ck_document_chunks_document_chunks_chunk_index_non_negative"),
        ),
        sa.CheckConstraint(
            "page_number IS NULL OR page_number >= 1",
            name=op.f("ck_document_chunks_document_chunks_page_number_positive"),
        ),
        sa.CheckConstraint(
            "token_count >= 0",
            name=op.f("ck_document_chunks_document_chunks_token_count_non_negative"),
        ),
        sa.ForeignKeyConstraint(
            ["document_id"],
            ["documents.id"],
    ...
    op.create_index(
        "idx_chunks_qdrant_point_id", "document_chunks", ["qdrant_point_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["organization_id"],
            ["organizations.id"],
            name=op.f("fk_evaluation_sets_organization_id_organizations"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_evaluation_sets")),
    )
    op.create_index(
        "idx_evaluation_sets_organization_id", "evaluation_sets", ["organization_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            ...
            name=op.f("ck_chat_messages_chat_messages_cost_non_negative"),
        ),
        sa.CheckConstraint(
            "latency_ms IS NULL OR latency_ms >= 0",
            name=op.f("ck_chat_messages_chat_messages_latency_non_negative"),
        ),
        sa.CheckConstraint(
            "role IN ('user', 'assistant', 'system')",
            name=op.f("ck_chat_messages_chat_messages_role_allowed"),
        ),
        sa.CheckConstraint(
            "token_input_count IS NULL OR token_input_count >= 0",
            name=op.f("ck_chat_messages_chat_messages_input_tokens_non_negative"),
        ),
        sa.CheckConstraint(
            "token_output_count IS NULL OR token_output_count >= 0",
            name=op.f("ck_chat_messages_chat_messages_output_tokens_non_negative"),
        ),
        sa.ForeignKeyConstraint(
            ["chat_session_id"],
            ["chat_sessions.id"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["evaluation_set_id"],
            ["evaluation_sets.id"],
            name=op.f("fk_evaluation_questions_evaluation_set_id_evaluation_sets"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["expected_document_id"],
            ["documents.id"],
            name=op.f("fk_evaluation_questions_expected_document_id_documents"),
            ondelete="SET NULL",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_evaluation_questions")),
    )
    op.create_index(
        "idx_evaluation_questions_set_id",
        "evaluation_questions",
        ["evaluation_set_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["evaluation_set_id"],
            ["evaluation_sets.id"],
            name=op.f("fk_evaluation_runs_evaluation_set_id_evaluation_sets"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_evaluation_runs")),
    )
    op.create_index(
        "idx_eval_runs_set", "evaluation_runs", ["evaluation_set_id", "created_at"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["chat_message_id"],
            ["chat_messages.id"],
            name=op.f("fk_pipeline_runs_chat_message_id_chat_messages"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["document_id"],
            ["documents.id"],
            name=op.f("fk_pipeline_runs_document_id_documents"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["evaluation_run_id"],
            ["evaluation_runs.id"],
            name=op.f("fk_pipeline_runs_evaluation_run_id_evaluation_runs"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["organization_id"],
            ["organizations.id"],
            name=op.f("fk_pipeline_runs_organization_id_organizations"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_pipeline_runs")),
    )
    op.create_index(
        "idx_pipeline_runs_chat_message_id", "pipeline_runs", ["chat_message_id"], unique=False
    )
    op.create_index("idx_pipeline_runs_document_id", "pipeline_runs", ["document_id"], unique=False)
    op.create_index(
        "idx_pipeline_runs_evaluation_run_id", "pipeline_runs", ["evaluation_run_id"], unique=False
    )
    op.create_index(
        "idx_pipeline_runs_org_created",
        "pipeline_runs",
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "duration_ms IS NULL OR duration_ms >= 0",
            name=op.f("ck_pipeline_events_pipeline_events_duration_non_negative"),
        ),
        sa.CheckConstraint(
            "sequence >= 0", name=op.f("ck_pipeline_events_pipeline_events_sequence_non_negative")
        ),
        sa.CheckConstraint(
        ...
        sa.ForeignKeyConstraint(
            ["pipeline_run_id"],
            ["pipeline_runs.id"],
            name=op.f("fk_pipeline_events_pipeline_run_id_pipeline_runs"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_pipeline_events")),
        sa.UniqueConstraint(
            "pipeline_run_id", "sequence", name=op.f("uq_pipeline_events_pipeline_run_id")
        ),
    )
    op.create_index(
        "idx_pipeline_events_node_status", "pipeline_events", ["node_name", "status"], unique=False
    )
    op.create_index(
        "idx_pipeline_events_run_sequence",
        "pipeline_events",
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "cost_usd IS NULL OR cost_usd >= 0",
            name=op.f("ck_usage_events_usage_events_cost_non_negative"),
        ),
        sa.CheckConstraint(
            "input_tokens IS NULL OR input_tokens >= 0",
            name=op.f("ck_usage_events_usage_events_input_tokens_non_negative"),
        ),
        sa.CheckConstraint(
            "output_tokens IS NULL OR output_tokens >= 0",
            name=op.f("ck_usage_events_usage_events_output_tokens_non_negative"),
        ),
        sa.ForeignKeyConstraint(
            ["organization_id"],
            ["organizations.id"],
    ...
    op.create_index(
        "idx_usage_org_created", "usage_events", ["organization_id", "created_at"], unique=False
    )
    ...
    op.create_index(
        "idx_audit_logs_org_created", "audit_logs", ["organization_id", "created_at"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            name=op.f("fk_evaluation_results_evaluation_question_id_evaluation_questions"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["evaluation_run_id"],
    ...
    op.create_index(
        "idx_evaluation_results_run_id", "evaluation_results", ["evaluation_run_id"], unique=False
    )
